...
> **⚠️** The %/weight figures below (132% / 89% boosts, ~45% of searches, 7.8% Wikipedia, SE Ranking / ZipTie / Princeton GEO percentages, crawler user-agent names) are DATED observational snapshots — verify against current official crawler docs and your own monitoring before using.
