...
> **⚠️** The citation-share %, lift figures, and study numbers below (Amsive 69%, Scrunch +182% / +117% / +185%, SimilarWeb 2.5× / 9%, etc.) are DATED observational snapshots, not causal benchmarks — verify before using. `community-marketing` referenced below is not a skill in this kit (nearest: `social-media-expert`).
...
| **Video and podcasts** | Increasingly retrieved; transcripts carry brand + category associations | video-marketing, social-media-expert |
...
1. **AI prompt tracking** — whether and how you're mentioned/recommended in LLM answers, even when no click ever lands (tools in ai-seo-playbook.md's Monitoring section). Track the framing around mentions — recommended, neutral, hedged, or recommended-against — not just the count.
