...
description: "When the user wants to research and produce competitor comparison / alternative PAGES for SEO and sales enablement — one page or a small, editorially-planned set. Also use when the user mentions 'alternative page,' 'vs page,' 'competitor comparison,' '[Product] vs [Product],' '[Product] alternative,' or 'competitive landing pages.' Covers four formats: singular alternative, plural alternatives, you vs competitor, and competitor vs competitor, with deep research and varied section types beyond feature tables. For GENERATING such pages at scale (templated systems over a dataset), hand off to programmatic-seo; for analyzing a rival (not publishing a page) see competitor-teardown; for ongoing change alerts see competitor-monitor. Triggers on: alternative page, vs page, competitor comparison, [Product] vs [Product], [Product] alternative, competitive landing pages."
---
...
- **seo-fundamentals**: For optimizing competitor pages
...
For the full page-format playbook, section templates, comparison-table craft, and data-file architecture, load: `references/comparison-page-guide.md`
