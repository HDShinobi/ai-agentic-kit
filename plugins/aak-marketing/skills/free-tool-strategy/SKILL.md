...
description: When the user wants to plan, evaluate, or build a free tool for marketing purposes — lead generation, SEO value, or brand awareness. Also use when the user mentions "engineering as marketing," "free tool," "marketing tool," "calculator," "generator," "interactive tool," "lead gen tool," "build a tool for leads," or "free resource." This skill bridges engineering and marketing — useful for founders and technical marketers. It covers tool STRATEGY (ideation, gating, build-vs-buy, MVP scope, ROI); for the build playbook of viral, share-focused generators (quiz/avatar/name makers), see viral-generator-builder. Triggers on: free tool, engineering as marketing, lead gen tool, marketing tool, build a tool for leads, free resource.
---
...
- **seo-fundamentals**: For SEO-optimizing the tool
- **analytics-marketing**: For measuring tool usage
...
For the full playbook, templates, and detailed checklists, load: `references/engineering-marketing-guide.md`
