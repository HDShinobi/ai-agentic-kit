...
| Optimizing a page using VOC insights | `conversion-optimization` |
| Building a competitor comparison page | `competitor-teardown` |
| Creating a churn prevention strategy from churn research | `churn-prevention` |
| Planning paid ads informed by research | `ppc-advertising` |
| Writing cold email using research on pain/trigger | `cold-email` |
| Translating customer research into an ICP for outbound | `lead-gen-scraper` |
| Planning content based on discovered topics | `content-marketing` |
