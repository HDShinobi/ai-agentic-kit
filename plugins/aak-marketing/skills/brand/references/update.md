...
Run the sync script:
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/brand/scripts/sync-brand-to-tokens.cjs
```
...
node ${CLAUDE_PLUGIN_ROOT}/skills/brand/scripts/inject-brand-context.cjs --json | head -30
