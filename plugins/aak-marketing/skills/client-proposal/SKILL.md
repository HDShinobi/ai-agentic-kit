...
A fill-in scaffold ships with this skill at `templates/proposal-template.md` — start from it and replace every bracket with the client's own words and real data. Never leave placeholder text or invent metrics, results, or testimonials.
