...
> **⚠️ Firecrawl and DataForSEO are OPTIONAL external MCP servers, not shipped with this kit.** If unavailable, substitute the built-in WebFetch/WebSearch tools for scraping and skip the SEO-metrics phase, noting "insufficient data" in the profile.
