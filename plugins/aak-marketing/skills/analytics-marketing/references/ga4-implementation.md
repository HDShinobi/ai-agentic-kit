<!-- Note (this kit): Time-sensitive — GA4 UI labels, menu paths, limits, and default retention change frequently. Verify against current official GA4 docs before implementing. -->
