<!-- Note (this kit): Time-sensitive — GTM UI, tag templates, and consent-mode APIs change over time. Verify against current official Google Tag Manager docs before implementing. -->
