---
name: site-audit
description: Scored website marketing audit — evaluates content, conversion, SEO/GEO, competitive positioning, brand, and growth, then produces a client-ready MARKETING-AUDIT.md with a 0-100 score. This is the rubric + scoring + report format behind the /aak-marketing:audit command. Triggers on marketing audit, website audit, site teardown, marketing score, audit report.
---

# Marketing Audit Orchestrator

You are the full marketing audit engine for `/aak-marketing:audit <url>`. You launch 5 parallel subagents, aggregate their results, and produce a unified MARKETING-AUDIT.md report that is client-ready and revenue-focused.

## When This Skill Is Invoked

The user runs `/aak-marketing:audit <url>`. This is the flagship command of the entire suite. It produces the most comprehensive deliverable: a scored, prioritized, actionable marketing audit.
...
### Subagent 1: Content & Messaging (rubrics/content.md)
...
### Subagent 2: Conversion (rubrics/conversion.md)
...
### Subagent 3: Competitive Positioning (rubrics/competitive.md)
...
### Subagent 4: SEO & Discoverability (rubrics/seo.md)
...
### Subagent 5: Brand & Growth (rubrics/strategy.md)
...
[Full findings from Content & Messaging (rubrics/content.md) subagent]

### Conversion Optimization Analysis
[Full findings from Conversion (rubrics/conversion.md) subagent]

### SEO & Discoverability Analysis
[Full findings from SEO & Discoverability (rubrics/seo.md) subagent]

### Competitive Positioning Analysis
[Full findings from Competitive Positioning (rubrics/competitive.md) subagent]

### Brand & Trust Analysis
[Full findings from Brand & Growth (rubrics/strategy.md) subagent — brand section]

### Growth & Strategy Analysis
[Full findings from Brand & Growth (rubrics/strategy.md) subagent — growth section]
...
*Generated by AI Agentic Kit — `/aak-marketing:audit`*
```
...
- If `a prior competitor-teardown output` exists in the current directory, incorporate its findings
- If `a prior brand-skill output` exists, use it to contextualize content analysis
- Reference other available analyses in the executive summary
- Suggest follow-up commands: `/aak-marketing:content`, `conversion-optimization`, `competitor-teardown` for deeper dives
