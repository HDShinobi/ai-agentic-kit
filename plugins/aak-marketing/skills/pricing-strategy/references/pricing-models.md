...
> **⚠️ The claims below — the "10:1 value-to-price ratio," "discount-askers churn ~2×," and "low prices hurt retention" — are attributed named-practitioner assertions (Kulp, Campbell/ProfitWell, Pigford, Tringas), not peer-reviewed studies. Directionally useful, but verify against your own cohort data before betting a price on them.**
