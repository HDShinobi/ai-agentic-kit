---
name: mcp-builder
description: MCP (Model Context Protocol) server and client engineering. Protocol design, schemas, transports, extensions, security, and migration. When building or reviewing MCP servers or clients, designing MCP tools/resources/prompts, migrating protocol versions, or validating MCP security and interoperability.
